...
local function BuildInformationTab(parent)
    ...
    R({ name="Missing Buffs",      desc="Dynamically tracks missing raid buffs based on group class composition.",         stateTable=db.raidBuffs, stateKey="enabled", pageId="indicators", tabIndex=8 })
