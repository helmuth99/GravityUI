...
local function BuildInformationTab(parent)
    ...
    R({ name="Targeted Spells",   desc="Castbars & audio alerts for enemy spells targeting you or group members.",      stateTable=db.screenindicators and db.screenindicators.targetedSpells, stateKey="enabled", pageId="features", tabIndex=7 })
    G()
    H("  Indicators")
    ...
    R({ name="Healer Mana",        desc="Shows spec icon, name and mana% of all healers in your party or raid.",          stateTable=db.screenindicators and db.screenindicators.healerMana, stateKey="enabled", pageId="indicators", tabIndex=3 })
    R({ name="Pet Info",           desc="Pet management tools and large status warnings for Hunters and Warlocks.",       stateTable=db.screenindicators and db.screenindicators.petWarnings, stateKey="enabled", pageId="indicators", tabIndex=4 })
    R({ name="Combat Timer",       desc="Visual stopwatch tracking time spent in combat. Great for M+ and raid analysis.", stateTable=db.uiimprovements and db.uiimprovements.combatTimer, stateKey="enabled", pageId="indicators", tabIndex=5 })
    R({ name="Cooldown Text",      desc="On-screen text alerts when tracked party spells go on cooldown.",                stateTable=db.cooldownText, stateKey="enabled", pageId="indicators", tabIndex=6 })
    R({ name="Missing Buffs",      desc="Dynamically tracks missing raid buffs based on group class composition.",         stateTable=db.raidBuffs, stateKey="enabled", pageId="indicators", tabIndex=7 })
    R({ name="Raid Warnings",      desc="Large centralized alerts for Soulwells, Feasts, Mage Tables, and Rituals.",      stateTable=db.raidWarnings, stateKey="enabled", pageId="indicators", tabIndex=8 })
    R({ name="Consumables",        desc="Shows missing consumables for group members during a Ready Check.",               stateTable=db.screenindicators and db.screenindicators.consumables, stateKey="enabled", pageId="indicators", tabIndex=9 })
    R({ name="Difficulty",         desc="Status bar showing current instance difficulty with a quick-change dropdown.",    stateTable=db.screenindicators and db.screenindicators.difficulty, stateKey="enabled", pageId="indicators", tabIndex=10 })
