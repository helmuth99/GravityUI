...
ns.Defaults = {
    ...
    -- fpsBackup intentionally omitted: must be nil until the user applies FPS
    -- settings for the first time. AceDB pre-populating this table would make
    -- BackupCurrentFPSSettings() think a backup already exists and skip the
    -- real CVar snapshot from WoW's current state.
-- Legacy QOL table removed
    ...
    actionbars =     {
        bar5_vis = true,
        bar8_vis = true,
        skinDominos = false,     -- Skin Dominos action buttons with GravityUI style
        skinBartender4 = false,  -- Skin Bartender4 action buttons with GravityUI style
        global =         {
            countFontSize = 10,
        ...
        enabled = true,
        bars =         {
            -- Main Action Bars (keys match BAR_CONFIG)
            MainBar = {
                enabled = true,
                alwaysShow = true,
                columns = 12, rows = 1,
                buttonWidth = 36, buttonHeight = 36,
                spacing = 1,
            ...
            Bar6 = {
                ...
                alwaysShow = false,
                columns = 2, rows = 6,
                buttonWidth = 34, buttonHeight = 34,
                spacing = 1,
                orientation = "horizontal",
            },
            Bar7 = {
            ...
            -- Extra bars (visibility/skinning only)
            MicroBar = {
                alwaysShow = false,
            },
            BagBar = {
