...
local function GetSettings()
    ...
    if guiCore and guiCore.db and guiCore.db.profile and guiCore.db.profile.skyriding then
        return guiCore.db.profile.skyriding
    end
    return nil
end
...
local function GetFontPath()
    local guiCore = _G.GravityUI and _G.GravityUI.guiCore
    if guiCore and guiCore.GetGlobalFont then
        return guiCore:GetGlobalFont()
    end
    -- Fallback to bundled Gravity font
    return [[Interface\AddOns\GravityUI\assets\Gravity.ttf]]									  
end
...
local function CreateSkyridingFrame()
    ...
    -- Apply GravityUI font to cooldown text (deferred to ensure template is initialized)
...
---------------------------------------------------------------------------
_G.GravityUI_RefreshSkyriding = ApplySettings
