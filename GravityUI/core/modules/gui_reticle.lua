...
local function GetSettings()
    ...
    if guiCore and guiCore.db and guiCore.db.profile and guiCore.db.profile.reticle then
        cachedSettings = guiCore.db.profile.reticle
...
local function CreateReticle()
    ...
    ringFrame = CreateFrame("Frame", "GravityUI_Reticle", UIParent)
...
---------------------------------------------------------------------------
_G.GravityUI_RefreshReticle = function()
    InvalidateCache()
    UpdateReticle()
end
