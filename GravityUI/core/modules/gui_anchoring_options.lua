...
local gui_Anchoring_Options = {}
ns.gui_Anchoring_Options = gui_Anchoring_Options
...
---------------------------------------------------------------------------
function gui_Anchoring_Options:CreateAnchorDropdown(parent, label, settingsDB, anchorKey, x, y, width, onChange, includeList, excludeList, excludeSelf)
    if not ns.gui_Anchoring or not ns.gui_Anchoring.GetAnchorTargetList then
        return nil
    end
    ...
    local function GetAnchorOptions()
        return ns.gui_Anchoring:GetAnchorTargetList(includeList, excludeList, excludeSelf)
    end
...
---------------------------------------------------------------------------
function gui_Anchoring_Options:CreateSnapButton(parent, text, x, y, width, height, onClick)
    width = width or 100
    height = height or 24
...
--   labelWidth: Width reserved for label (default: 200)
-- Returns: container frame and array of buttons
---------------------------------------------------------------------------
function gui_Anchoring_Options:CreateSnapButtonsRow(parent, label, x, y, snapTargets, settingsDB, anchorKey, getFrame, onSnap, onFailure, spacing, buttonWidth, buttonHeight, labelWidth)
    spacing = spacing or 8
    buttonWidth = buttonWidth or 100
    buttonHeight = buttonHeight or 24
    labelWidth = labelWidth or 200
    ...
    for i, snapTarget in ipairs(snapTargets) do
        local button = self:CreateSnapButton(
            ...
            function()
                ...
                local success = ns.gui_Anchoring:SnapTo(
                    frame,
...
---------------------------------------------------------------------------
function gui_Anchoring_Options:GetNinePointAnchorOptions()
    return {
...
---------------------------------------------------------------------------
function gui_Anchoring_Options:CreateAnchorPointSelector(parent, label, settingsDB, key, x, y, onChange, size)
    size = size or 200
    local C = GetColors()
...
---------------------------------------------------------------------------
function gui_Anchoring_Options:CreateMultiAnchorPopover(anchorButton, settingsDB, onChange, anchorsKey, maxAnchors)
...
---------------------------------------------------------------------------
function gui_Anchoring_Options:CreateAnchorPresetControls(parent, settingsDB, x, y, onChange, PAD, FORM_ROW, anchorsKey, maxAnchors, onPresetChange)
    anchorsKey = anchorsKey or "anchors"
    maxAnchors = maxAnchors or 2
    ...
    -- Align first button to match dropdown alignment (200px from left, same as CreateFormDropdown)
    ...
    presetAboveBtn:SetPoint("LEFT", presetButtonContainer, "LEFT", 200, 0)
...
---------------------------------------------------------------------------
function gui_Anchoring_Options:CreateMultiAnchorDialog(settingsDB, onChange, anchorsKey, maxAnchors)
    anchorsKey = anchorsKey or "anchors"
    maxAnchors = maxAnchors or 2
...
---------------------------------------------------------------------------
function gui_Anchoring_Options:CreateMultiAnchorControls(parent, settingsDB, x, y, onChange, PAD, FORM_ROW, anchorsKey, maxAnchors)
    anchorsKey = anchorsKey or "anchors"
    maxAnchors = maxAnchors or 2
...
---------------------------------------------------------------------------
function gui_Anchoring_Options:CreateAnchorPointControls(parent, settingsDB, x, y, onChange, PAD, FORM_ROW, sourceKey, targetKey, sourceLabel, targetLabel)
...
---------------------------------------------------------------------------
function gui_Anchoring_Options:CreateOffsetControls(parent, settingsDB, x, y, onChange, PAD, FORM_ROW)
    local GUI = GetGUI()
    if not GUI then
        return nil, nil, y
    end
...
---------------------------------------------------------------------------
function gui_Anchoring_Options:CreateAnchorControls(parent, settingsDB, x, y, onChange, PAD, FORM_ROW, anchorKey, anchorsKey, maxAnchors, excludeSelf, dropdownLabel, offsetMin, offsetMax, onPresetChange)
