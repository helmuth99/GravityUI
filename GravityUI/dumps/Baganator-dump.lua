...
function private:BaganatorInstallTwink()
...
function private:BaganatorInstall()
    BAGANATOR_CONFIG = BaganatorDump
    local name = UnitName("PLAYER")
    local realm = GetRealmName()
    BAGANATOR_CONFIG["sort_ignore_bank_slots_count"][name .. "-" .. realm] = 0
    BAGANATOR_CONFIG["sort_ignore_slots_count_2"][name .. "-" .. realm] = 0
    PluginInstallStepComplete.message = "Baganator Imported"
