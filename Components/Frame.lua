...
CUI.InstallerData  = {
    Title =  CUI.PluginName,
    Name = CUI.PluginName,
    --tutorialImage = "todo", --todo,
    Pages = {
        [1] = function()
            if CronixUI_DB.global and CronixUI_DB.global.installed then
                PluginInstallFrame.SubTitle:SetText("Welcome to the Installation for Cronixui")
                PluginInstallFrame.Desc1:SetText("Thank you for chossing " .. CUI.PluginName .. " again. You have installed " .. CUI.PluginName .. " befor." )
                PluginInstallFrame.Desc2:SetText("If you would like to go through the installation again you can click the continue button. |cffff0000!!WARNING:!!|r Doing so will reset all of your profiles again. You can also click 'Skip Process' if you don't want the CronixUI profiles on this character.")
